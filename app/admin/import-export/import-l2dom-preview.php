...
<!-- header -->
<div class="pHeader"><?php print _("L2 Domain import data preview"); ?></div>
...
<div class="pFooter">
	<div class="btn-group">
		...
		<button class="btn btn-sm btn-default" id="dataImportSubmit" data-type="l2dom" disabled><i class="fa fa-download"></i> <?php print _('Import'); ?></button>
	</div>
</div>
