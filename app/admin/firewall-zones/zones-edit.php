...
<table class="table table-noborder table-condensed">
	...
	<tr>
		...
		print '<input type="hidden" name="action" value="'.escape_input($POST->action).'">';
	...
	<?php if($firewallZone->generator != 2 && $firewallZoneSettings['zoneGenerator'] != 2) { ?>
		<tr>
			...
			<td>
				<input type="checkbox" class="input-switch" name="padding" <?php if($POST->action == 'edit' && $firewallZone->padding == 1){ print 'checked';} elseif($POST->action == 'edit' && $firewallZone->padding == 0) {} elseif ($firewallZoneSettings['padding'] == 'on'){print 'checked';}?>>
			</td>
		</tr>
	<?php } ?>
	<tr>
...
<div class="pFooter">
	<div class="btn-group">
		...
		<button class="btn btn-sm btn-default <?php if($POST->action=="delete") { print "btn-danger"; } else { print "btn-success"; } ?>" id="editZoneSubmit"><i class="fa <?php if($POST->action=="add") { print "fa-plus"; } elseif ($POST->action=="delete") { print "fa-trash-o"; } else { print "fa-check"; } ?>"></i> <?php print $User->get_post_action(); ?></button>
	</div>
	<!-- result -->
